...
namespace DBus {
    ...
    class Type::Uint16 : public Basic {
    public:
        Uint16() = default;
        Uint16(const std::uint16_t v);

        static constexpr const char *name = "Uint16";
        static constexpr std::size_t alignment = 2;
        static constexpr const char code = 'q';
        ...
        operator std::uint16_t() const { return m_Value; };
